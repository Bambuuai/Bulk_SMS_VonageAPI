...
const CampaignReplies = () => {
	...
	useEffect(() => {
		setIsLoading(true);
		axios
			.get(USER_ENDPOINTS.GET_CAMPAIGN_CHATS)
			.then(({ data }) => {
		...
		<div className="grid grid-cols-1 gap-5 h-full">
			{campaigns.length ? (
				...
				<div className="h-full flex flex-col justify-center items-center container-center">
					<img
						className="w-60"
						src="/assets/images/custom/no-replies.png"
						alt="Illustration showing that there are no replies"
					/>
